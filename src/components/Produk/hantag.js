...
const Hantag = () => {
  ...
  return (
    <div className="dusmakanan">
      <h2 className="animated">Kami hampir bisa membuat segala jenis label dan hantag kami juga sudah menjadi pemasok untuk brand lokal</h2>
